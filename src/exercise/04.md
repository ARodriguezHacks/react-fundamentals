...
#### In regards to checking props' types:

As of React 15.5.0, The 'PropTypes' was deprecated.
Question: What were 'PropTypes'?
As of React 19, the propType property/method that checks from the React package have been removed.
Further Research Links:
- https://react.dev/blog/2024/04/25/react-19-upgrade-guide#removed-proptypes-and-defaultprops
- https://legacy.reactjs.org/docs/typechecking-with-proptypes.html
- https://legacy.reactjs.org/blog/2017/04/07/react-v15.5.0.html#new-deprecation-warnings
- https://www.npmjs.com/package/prop-types

*As of 2024, it recommended to use TypeScript for static type-checking.
It is worth learning how legacy propTypes works though.
